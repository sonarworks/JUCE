...
namespace detail
{
    ...
    */
    const LayoutPair layoutTable[]
    {
        ...
        { kCineFront,                   { X::left, X::right, X::LFE, X::topSideLeft, X::topSideRight } },
        { k81MPEG3D,                    { X::left, X::right, X::leftSurroundRear, X::rightSurroundRear, X::LFE, X::topFrontLeft, X::topFrontRight, X::topRearLeft, X::topRearRight } },
